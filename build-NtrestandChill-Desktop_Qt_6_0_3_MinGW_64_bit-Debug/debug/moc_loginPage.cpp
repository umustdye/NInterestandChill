...
#include <memory>
#include "../../NtrestandChill/loginPage.h"
...
QT_MOC_LITERAL(10, 10), // "closeLogin"
QT_MOC_LITERAL(21, 0), // ""
QT_MOC_LITERAL(22, 24), // "on_createAccount_clicked"
QT_MOC_LITERAL(47, 16) // "on_login_clicked"

    },
    "LoginPage\0closeLogin\0\0on_createAccount_clicked\0"
    "on_login_clicked"
};
...
void LoginPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LoginPage::closeLogin)) {
                *result = 0;
                return;
            }
        }
