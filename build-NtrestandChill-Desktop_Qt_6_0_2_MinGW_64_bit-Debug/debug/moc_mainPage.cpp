...
#include <memory>
#include "../../NtrestandChill/mainPage.h"
...
QT_MOC_LITERAL(9, 19), // "changeToLeaderBoard"
QT_MOC_LITERAL(29, 0), // ""
QT_MOC_LITERAL(30, 20) // "on_highScore_clicked"

    },
    "MainPage\0changeToLeaderBoard\0\0"
    "on_highScore_clicked"
};
...
void MainPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->changeToLeaderBoard(); break;
        case 1: _t->on_highScore_clicked(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MainPage::changeToLeaderBoard)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MainPage::changeToLeaderBoard()
{
